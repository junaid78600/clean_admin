		...
		<div class="container">
			<div class="login-screen row align-items-center" style="width: 444px;margin: auto;">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<form  action="<?=base_url();?>UserLogin/authenticate_login" method="post">
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<h4 class="text-center">User Panel</h4>
										...
										<div class="input-group">
											...
											<input type="email" class="form-control" name="email" placeholder="Email" aria-label="username" aria-describedby="username" required>
										</div>
										<br>
										<div class="input-group">
