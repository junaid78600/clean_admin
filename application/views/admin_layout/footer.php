		...
		<!-- D3 JS -->
		<!-- <script src="<?=base_url()?>assets/cms_layout/vendor/d3/d3.min.js"></script> -->

		<!-- C3 Graphs -->
		<!-- <script src="<?=base_url()?>assets/cms_layout/vendor/c3/c3.min.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/c3/custom/bar-graph.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/c3/custom/line-graph.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/c3/custom/line-graph-overview.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/c3/custom/line-graph-one.js"></script> -->
		<!-- notification -->
		<script src="<?=base_url()?>assets/cms_layout/js/jquery.easing.1.3.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/notify/notify.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/vendor/notify/notify-custom.js"></script>
		<!-- calander -->
		<script src="<?=base_url()?>assets/cms_layout/js/bootstrap-datetimepicker.js"></script>
		<script src="<?=base_url()?>assets/cms_layout/js/locales/bootstrap-datetimepicker.fr.js"></script>
