				...
				<form method="POST" name="myForm" id="myForm"  enctype="multipart/form-data" onsubmit="return form_validation()">
		           <div class="form-group row">
		            ...
		            <div class="col-md-3">
		              ...
		              <input type="text"  name="stock"  required class="form-control-sm form-control">
		            </div>
					<div class="col-md-3">
		            ...
		            <div class="col-md-3">
		              ...
		              <input type="number"  name="price"  required class="form-control-sm form-control">
		            </div>
		          ...
		          <div class="form-group row">
		            ...
		            <div class="col-md-3">
		              ...
		              <input type="file" id="image"  name="files" required  class="form-control-sm form-control">
		            </div>
		            <div class="col-md-3">
...
{   
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url(); ?>AjaxRequest/saveProduct',
      data: form,
      cache: false,
      contentType: false,
      processData: false,
