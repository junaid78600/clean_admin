											...
											<?php foreach ($data as $row):?>
                                              ...
                                              <td style="display:none" ><?=$row->user_id?></td>
												...
												<td style="padding: 2px;text-align: center;" width="15%">
														<a target="blank" href="<?=base_url()?>admin/dealer_dashboard/?id=<?=$row->user_id?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Order Details"  class="btn btn-outline-success btn-sm"><span class="icon-eye" ></span>
													</a>
