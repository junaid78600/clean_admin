									...
									<div class="card-body">
										...
										<div class="row form alert">
                                            ...
                                            <div class="col-xs-4" style="padding: 0;">
                                                <button type="button" onClick="placeOrder()" class="btn btn-success btn-block btn-flat" id="payment" style="height:67px;">Payment</button>
                                            </div>
                                        </div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	{		
		...
		notes.show("Action Fail", {
			...
			return false;}
		$.post("<?=base_url()?>cart/place_order",{dealer,location},
